<div align="center">
  <br />
  <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="1" width="98" height="98" rx="22" fill="#0D1418" stroke="rgba(195,207,211,.28)" stroke-width="2"/><g transform="translate(50 50) scale(0.8052) translate(-60 -50)"><path d="M58 30 H33 Q26 30 26 37 V43 Q26 50 33 50 H51 Q58 50 58 57 V63 Q58 70 51 70 H26" stroke="#2ED3C0" stroke-width="9"/><path d="M76 70 H94" stroke="#FF6B1A" stroke-width="9"/></g></svg>
