...
- **En dash.** Use it after a bolded lead-in term in a definition-style bullet (see §8).
...
- **Sentence structure.** Default to full sentences in prose, paragraphs, user stories, and instructions. The one exception is a definition-style bullet, which pairs a bolded term with an en dash and a fragment (see §8).
...
- **Lists.**
  ...
  - **Definition-style bullets** – A bolded term, an en dash, and a fragment stating the core definition. A full sentence may follow for elaboration. Example: `**Severity** – The level of seriousness of an issue. Severity is measured by...`
